...
public class MainActivity extends AppCompatActivity {
    ...
    public String main_url_webview = "https://www.drdistributor.com/new_api/api_mobile_html45/"; // Notification_Service ke page par be alag sau use ho raha ha so plz wha be kar layna change
