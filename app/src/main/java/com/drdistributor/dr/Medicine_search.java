    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (user_type.equals("sales")) {
            ...
            if (chemist_id.equals("")) {
                ...
                Intent myIntent = new Intent(Medicine_search.this,
        ...
        cart_LinearLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                in.setClass(Medicine_search.this, My_cart.class);
                startActivity(in);
                finish();
            }
        });
        ...
        adapter = new Medicine_search_Adapter(Medicine_search.this, Search_medicine_List);
        listView1.setAdapter(adapter);

        listView2 = findViewById(R.id.listView2);
        Medicine_cart_adapter = new My_cart_Adapter(Medicine_search.this, My_cart_List);
...
//                            }, 1000);
        ...
        listView1.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1,
                ...
                Intent in = new Intent();
                in.setClass(Medicine_search.this, Medicine_details.class);
